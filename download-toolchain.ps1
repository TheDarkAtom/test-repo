...
$url = "https://github.com/mstorsjo/llvm-mingw/releases/download/$llvm_version/llvm-mingw-$llvm_version-msvcrt-$Arch.zip"
Write-Host $url
try {
...
Rename-Item -Path "toolchain/llvm-mingw-$llvm_version-msvcrt-$Arch" -NewName "mingw"
